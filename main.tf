...
# The process is similar to the IAM role creation for the EKS cluster
# Except this time the policies that you attach will be for the EKS worker node policies
resource "aws_iam_role" "workernodes" {
 ...
 # The last bit of code is to create the worker nodes.
 # For testing purposes, use just one worker node in the scaling_config configuration.
...
resource "aws_eks_node_group" "worker-node-group" {
  ...
  node_group_name = "example-workernodes"
